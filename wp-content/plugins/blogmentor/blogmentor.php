...
if (!function_exists('bm_elements_widget_fail_load')) {
    ...
    function bm_elements_widget_fail_load() {
        ...
        if (bm_elements_elementor_installed()) {
            ...
            $message = '<p>' . __('<strong>Blogmentor<strong> widgets not working because you need to activate the Elementor plugin.', BM_DOMAIN) . '</p>';
            ...
            $message = '<p>' . __('<strong>Blogmentor</strong> widgets not working because you need to install the Elemenor plugin', BM_DOMAIN) . '</p>';
...
if (!function_exists('bm_elements_elementor_update_notice')) {
    ...
    function bm_elements_elementor_update_notice() {
        ...
        $message = '<p>' . __('<strong>Blogmentor</strong> widgets not working because you are using an old version of Elementor.', CTW_DOMAIN) . '</p>';
