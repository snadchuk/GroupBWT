		...
		<?php if ( 'yes' === $data->show_read_more ) : ?>
			<div class="w-100 anwp-pg-read-more mt-auto">
				<a href="<?php the_permalink( $wp_post ); ?>" <?php echo $open_link_in_new_tab ? 'target="_blank"' : ''; ?>
					class="anwp-pg-read-more__btn mt-3 mb-0 <?php echo esc_attr( $data->read_more_class ? $data->read_more_class : 'btn btn-sm btn-outline-info w-100 text-decoration-none' ); ?>">
